    ...
    : QObject{parent}
{
    ...
    init_ska_x_mvb1_table(SKA_VEHICLE_NUM::SKA1);
    init_ska_x_mvb2_table(SKA_VEHICLE_NUM::SKA1);
    //init_oa_x_mvb3_table(SKA_VEHICLE_NUM::SKA1);

    // Init SKA2 Table Contents
    init_ska_x_mvb1_table(SKA_VEHICLE_NUM::SKA2);
    init_ska_x_mvb2_table(SKA_VEHICLE_NUM::SKA2);
...
void Ska_Bcu::set_data_struct(const QByteArray &input, const SKA_VEHICLE_NUM &ska_x_num)
{
    ...
    if (input.size() == sizeof(m_ska_x_bcu[ska_num])) {
        ...
        //qDebug() << "SIZE of MVB1 BYTES :  " << sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1.bytes);
        //qDebug() << "SIZE of MVB2 BYTES :  " << sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb2.bytes);
        qDebug() << "SIZE of Bcu_Ccu_Mvb1 STRUCT :  " << sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1);
        qDebug() << "SIZE of Bcu_Ccu_Mvb2 STRUCT :  " << sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb2);
        //qDebug() << "SIZE of MVB3 :  " << sizeof(m_ska_x_bcu[ska_num].oa_etcs_ccu_mvb3.bytes);


        // İlk alanı kopyala
        memcpy(&m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1, input.constData(), sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1));

        QByteArray data =  input.mid(0, 56);
        //qDebug() << "32 Bytelık data :  " << data;
        utils::show_bytearray(data,"data");//show_bytearray(QByteArray byteData, QString data_name)
        ...
        memcpy(&m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb2, input.constData() + sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1), sizeof(m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb2));
...
void Ska_Bcu::init_ska_x_mvb1_table(SKA_VEHICLE_NUM vehicle_type)
{
...
void Ska_Bcu::init_ska_x_mvb2_table(SKA_VEHICLE_NUM vehicle_type)
{
    int ska_num = static_cast<int>(vehicle_type);
